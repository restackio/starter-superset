...
SECRET_KEY = 'adfajfWE@SVSBAGAgagdasjdf;a'
...
# Max tries to run queries to prevent false errors caused by transient errors being returned to users. Set to a value >1 to enable retries.
